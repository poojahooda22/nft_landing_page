...
const App = () => {
  return (
    <>
      ...
      <SectionWrapper
        title="Deployment"
        description="ProNef is bulit using Expo which runs natively on all users' devices. You can easily get your app into people's hands"
      ...
      <div className='px-4 py-2 justify-center items-center bg-primary flex-col text-center banner04'>
        ...
        >Made with love by {" "}
        <span className='bold'>Pooja Hooda</span>
        </p>
      </div>
    </>
  );
